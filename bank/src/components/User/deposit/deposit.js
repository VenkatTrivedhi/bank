...
function Deposit() {
    ...
    const handleDeposit = async () => {
        ...
        console.log("dipositsss")

        const resp = await axios.post(`http://localhost:8000/api/v1/deposit/${paramsUsername}`, {amount}).catch((error) => {
            return error
        })
    ...
    return(
        ...
        <div className="form-container">
            <form >
                ...
                <Button size='small' onClick={() => handleDeposit()}>Deposit</Button> <br></br>
